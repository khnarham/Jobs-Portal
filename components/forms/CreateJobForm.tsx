  ...
  return (
    <Form {...form}>
      ...
      >
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input className="border-2 border-zinc-700" placeholder="Job Title" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectGroup className="border-2 border-zinc-700">
        ...
        <Button type="submit" className="w-full bg-green-500 text-white hover:bg-green-600" disabled={pending}>
